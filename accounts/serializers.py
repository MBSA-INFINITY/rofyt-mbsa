...
class DriverProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id','first_name', 'last_name', 'phone', 'email', 'full_address', 'pincode',
                    'state', 'city', 'house_or_building', 'road_or_area', 'alternate_number',
                    'aadhar_number', 'aadhar_upload_front', 'aadhar_upload_back', 'pan_number',
                    'pan_upload', 'license_number', 'license_upload_front', 'license_upload_back',
